...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 229603664, ; hash 0xdaf7950, from name: BA.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 339291713, ; hash 0x14392e41, from name: BA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BA.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	...
	%struct.DSOCacheEntry {
		i64 1090364861, ; hash 0x40fda5bd, from name: libaot-BA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BA.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 1467070708, ; hash 0x5771b8f4, from name: libaot-BA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BA.dll.so
		ptr null; void* handle (0x0)
	}, ; 164
	...
	%struct.DSOCacheEntry {
		i64 3379754044, ; hash 0xc972f43c, from name: aot-BA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BA.dll.so
		ptr null; void* handle (0x0)
	}, ; 398
	...
	%struct.DSOCacheEntry {
		i64 3975094143, ; hash 0xecef1f7f, from name: aot-BA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BA.dll.so
		ptr null; void* handle (0x0)
	}, ; 463
